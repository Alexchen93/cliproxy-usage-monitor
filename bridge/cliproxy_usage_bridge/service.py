...
class SummaryService:
    def __init__(
        ...
        *,
        ...
        self.config = config
        self.client = client or ManagementClient(config)
    ...
    def _start_refresh_locked(self) -> None:
        ...
        threading.Thread(target=self.refresh, daemon=True, name="quota-refresh").start()
    ...
    def refresh(self) -> None:
        ...
        try:
            provider, errors, online = collect_codex(self.client)
        ...
        with self._lock:
            ...
            self._summary = {
                ...
                "proxy": {
                    "online": online,
                    "latency_ms": latency,
                    "auth_status": "error" if self.client.auth_blocked else "ok",
                },
