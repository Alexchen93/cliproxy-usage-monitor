...
test('groups model quotas by a generic source name with label and id fallbacks', () => {
...
test('returns no model groups for incomplete quota data', () => {
    assert.deepEqual(modelSourceGroups(null), []);
    assert.deepEqual(modelSourceGroups({ignored: null}), []);
});
